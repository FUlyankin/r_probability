...
<table id="t01">
  ...
  <tr>
    <td> 3 </td>
      <td> <a href="https://github.com/FUlyankin/r_probability/blob/master/end_seminars_2019/HW/HW3.ipynb" target="_blank"> Метод максимального правдоподобия, метод моментов</a> </td>
    <td> Хочу шаблон </td>
    <td> 100 </td>
    <td> 10.07.19 </td>
    <td> решение </td>
