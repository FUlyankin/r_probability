...
Лучше всего ЦПТ и фальсификации в самом начале после генерации случайных величин. Потому что хочется завлечь народ практичностью теорвера.

не знаю как лучше распределить эти три штуки:
* Генерация случайных величин, Варка
* ЗБЧ и ЦПТ. Поиск фальсификаций. Поиск похожестей. Задача Кристины. Метрические алгоритмы. Проклятье размерности.
* Комбинаторика, монте-карло
